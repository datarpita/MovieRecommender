...
function createProduct(id) {
	alert("In createProduct");
	$("#productcontainer").append('<div class="row"><div class="col-md-4"><img class="img-responsive" src="../images/product.png" alt="product" border="1">'+
	                            	'</div><div class="col-md-8"><h3>Moto 4 Plus 5th Generation</h3><h5>sfsdfsfsdfsfsfsfsdfsdfsdfsfsf</h5>'+
	                            	'<h6><span class="label label-default">Smartphones</span></h6></div></div><div class="row"><div class="col-md-4" align="right">'+
                            		'<h5><span class="glyphicon glyphicon-upload">Upload</span></h5></div><div class="col-md-8"></div></div>'+
                            	'<div class="row"><div class="col-md-12"><div class="well well-sm" align="right"><div class="form-group"><button type="button" class="btn btn-danger">Remove</button>'+
									'<button type="button" class="btn btn-success">Edit</button></div></div></div></div>');
